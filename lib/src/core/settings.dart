...
class AppSettings {
  ...
  factory AppSettings.fromJson(Map<String, dynamic> json) => AppSettings(
        ...
        concurrentDownloads: (json['concurrentDownloads'] as int? ?? 2).clamp(1, 5),
        ...
        playerControlsTimeoutSeconds: (json['playerControlsTimeoutSeconds'] as int? ?? 4).clamp(1, 15),
        ...
        dohTimeoutSeconds: (json['dohTimeoutSeconds'] as int? ?? 10).clamp(1, 60),
        useHorizontalSearchCards: json['useHorizontalSearchCards'] as bool? ?? true,
        searchCardsPerRow: (json['searchCardsPerRow'] as int? ?? 2).clamp(1, 3),
        ...
        minimumVideoDurationSeconds: (json['minimumVideoDurationSeconds'] as int? ?? 0).clamp(0, 86400),
        minimumVideoViews: (json['minimumVideoViews'] as int? ?? 0).clamp(0, 1000000000),
